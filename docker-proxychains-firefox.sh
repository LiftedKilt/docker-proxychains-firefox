...
#docker pull liftedkilt/proxychains-firefox:latest
...
docker exec -it proxychains-firefox nohup ssh -o "StrictHostKeyChecking no" -TND 12345 ${SSH_USER}@${SSH_SERVER} -i /id_rsa
